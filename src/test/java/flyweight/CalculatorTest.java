...
public class CalculatorTest {
    ...
    public void testComputeIfEmpty() {
        ...
        assertThat(calculator.calculateDistances(Collections.EMPTY_LIST, 200), equalTo(0));
        assertThat(calculator.calculateDistances(Arrays.asList(Rectangle.getInstance(100, 100)), 200), equalTo(0));
    }
    ...
    public void testComputeMore() {
        List<Rectangle> rectangles = IntStream
                .range(0, 100)
                .mapToObj(i -> Rectangle.getInstance(10, 10))
